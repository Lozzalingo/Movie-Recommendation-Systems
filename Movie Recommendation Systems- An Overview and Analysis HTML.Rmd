...
```{r, null_prefix =TRUE, message=FALSE}
...
plot(svd_result$d, pch=20, col = "blue", cex = 1.5, xlab='Singular Values %', ylab='Magnitude', 
...
plot(perc_vec, pch=20, col = "blue", cex = 1.5, xlab='Singular Values %', 
